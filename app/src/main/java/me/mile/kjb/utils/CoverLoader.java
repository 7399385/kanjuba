...
public class CoverLoader {
    ...
    private Bitmap getDefaultCover(Type type) {
        switch (type) {
            case BLUR:
                return BitmapFactory.decodeResource(mContext.getResources(), me.mile.kjb.R.drawable.play_page_default_bg);
            case ROUND:
                Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), me.mile.kjb.R.drawable.play_page_default_cover);
                bitmap = ImageUtils.resizeImage(bitmap, ScreenUtils.getScreenWidth() / 2, ScreenUtils.getScreenWidth() / 2);
                return bitmap;
            default:
                return BitmapFactory.decodeResource(mContext.getResources(), me.mile.kjb.R.drawable.default_cover);
        }
    }
